...
return array(
    'columns' => array(
        'pointlog_id' => array(
            ...
            //'pkey' => true,
            'autoincrement' => true,
            'label' => app::get('sysuser')->_('下线积分记录id'),
        ),
        'user_id' => array(
            'type' => 'table:user',
            'in_list' => false,
        ...
        'point' => array(
            ...
            'default_in_list' => true,
            'default' => 0,
            'comment' => app::get('sysuser')->_('线下积分值'),
            'label' => app::get('sysuser')->_('线下积分值'),
        ),
        'remark' => array(
            //'type' => 'varchar(500)',
            'type' => 'string',
            ...
            'in_list' => true,
            'default_in_list' => true,
            'comment' => app::get('sysuser')->_('线下备注(记录订单号)'),
            'label' => app::get('sysuser')->_('线下备注'),
        ),
    ...
    'comment' => app::get('sysuser')->_('线下会员积分值明细表'),
);
