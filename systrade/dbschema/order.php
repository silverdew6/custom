...
return  array(
    'columns'=>array(
		...
		'ordtax_rate_price' => array(
            'type' => 'money',
            'default' => '0',
            'label' => app::get('systrade')->_('子订单消费税'),
            'comment' => app::get('systrade')->_('子订单消费税'),
        ),
				'ordreg_rate_price' => array(
            'type' => 'money',
            'default' => '0',
            'label' => app::get('systrade')->_('子订单增值税'),
            'comment' => app::get('systrade')->_('子订单增值税'),
        ),
        'num' => array(
            'type' => 'number',
        ...
        'zonghe_rate' => array(
            ...
            'scale' => 3,
            'default' => 0,
            'label' => app::get('systrade')->_('综合税率'),
            'comment' => app::get('systrade')->_('综合税率'),
        ),
        'discount_fee' => array(
            'type' => 'money',
            'default' => '0',
