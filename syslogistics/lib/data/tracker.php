...
class syslogistics_data_tracker {
    ...
    public function pullFromHqepay($LogisticCode, $ShipperCode)
    {
        ...
        //print_r($hqepayParams);

	//$hqepayParams["id"] = "1266734";
	//$hqepayParams["appkey"] = "187dff3c-50a9-47f4-86ce-f7af0b38ddfb";
	...
	//$content = "{'OrderCode':'', 'ShipperCode':'EMS', 'LogisticCode':'BE663962001NL'}";
