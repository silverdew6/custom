...
class ectools_api_payment_tlkj{
    ...
    public function getParams()
    {
        $return['params'] = array(
            ...
            'productName'       => ['type'=>'string','valid'=>'', 'description'=>'商品秒描述', 'default'=>'', 'example'=>''],
            'type'              => ['type'=>'string','valid'=>'', 'description'=>'交易类型', 'default'=>'', 'example'=>''],
            'orderDatetime'     => ['type'=>'string','valid'=>'', 'description'=>'交易时间', 'default'=>'', 'example'=>''],
            'userid'            => ['type'=>'string','valid'=>'', 'description'=>'签名信息', 'default'=>'', 'example'=>''],
    ...
    public function pay($params)
    {
        ...
        $res = $Objdata-> pay($params);return $res;
    }
    //单笔订单查询接口
