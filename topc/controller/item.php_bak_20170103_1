...
public function creatimgbig()
	...
	//打上文字
		...
		imagefttext($dst, 16, 0, 100, 665, $black, $font, $name);
		imagefttext($dst, 13, 0, 80, 679, $black, $font, $size);
		imagefttext($dst, 13, 0, 80, 747, $black, $font, $origin);
		imagefttext($dst, 45, 0, 130, 840, $black, $pricefont, $price);
		$logo = imagecreatefrompng($png);
		imagecopyresampled($dst, $logo, 390, 679, 0, 0, 200, 200,200, 200);
		// Content type
