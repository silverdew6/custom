...
'$(window).on("unload",function(){'.$remove_cookie.'});</script>';
        ...
        $icp_link = app::get('site')->getConf('system.site_icp_link');
        empty($icp_link) and  $icp_link = "http://www.beianbeian.com/beianxinxi/5342ff56-e0ae-4779-b5e7-7c55f934f984.html";
        $icp and $html .= '<div style="text-align: center;"><a href="'.$icp_link.'" title="查看备案信息" target="_blank">'.$icp.'</a></div>';
        return $html;
    }//End Function
