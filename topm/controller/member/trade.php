...
class topm_ctl_member_trade extends topm_ctl_member{
    ...
    public function detail()
    {
        ...
        $params['fields'] = "tid,status,payment,points_fee,post_fee,created_time,cancel_status,receiver_state,receiver_city,receiver_district,ziti_addr,ziti_memo,receiver_address,trade_memo,receiver_name,receiver_mobile,orders.oid,orders.price,orders.num,orders.title,orders.aftersales_status,orders.complaints_status,orders.item_id,orders.pic_path,total_fee,discount_fee,buyer_rate,adjust_fee,orders.spec_nature_info,activity,pay_type,cancel_reason,orders.spec_nature_info,shipping_freedesc,use_coupon_money";
