...
return  array(
    'columns' => array(
        ...
        'tax_rate_price' => array(
            'type' => 'money',
            'default' => '0',
            'label' => app::get('systrade')->_('消费税'),
            'comment' => app::get('systrade')->_('消费税'),
        ),
        'zonghe_ratemoney' => array(
            'type' => 'money',
            'default' => '0',
            'label' => app::get('systrade')->_('综合税'),
            'comment' => app::get('systrade')->_('综合税'),
        ),
		'reg_rate_price' => array(
            'type' => 'money',
            'default' => '0',
            'label' => app::get('systrade')->_('增值税'),
            'comment' => app::get('systrade')->_('增值税'),
        ),
        'points_fee' => array(
            'type' => 'money',
            'default' => '0',
        ...
        'use_coupon_money' => array(
            'type' => 'money',
            'default' => '0',
            'comment' => app::get('systrade')->_('优惠券抵订单金额'),
        ),
        ...
        'ziti_memo' => array(
		    ...
		    'tax' => array(
            'type' => 'number',
            'comment' => app::get('systrade')->_('业务模式，1完税，2保税，3直邮'),
        ),
		'sea_region' => array(
            'type' => 'number',
            'comment' => app::get('systrade')->_('业务区域，保税和直邮的，完税的不准确，暂时不考虑'),
        ),
        'shipping_freedesc' => array(
            'type' => 'string',
            'comment' => app::get('systrade')->_('订单包邮以及参加特殊活动内容标记'),
         ),
		'card_id' => array(
            'type' => 'string',
            'length' => 30,
            'comment' => app::get('systrade')->_('身份证号码'),
        ),
    ),
    'primary' => 'tid',
    'index' => array(
