<?php
class topm_ctl_member_pointoff extends topm_ctl_member{
    ...
    public function point()
    {
        ...
        $pagedata['title'] = "我的线下积分";
        return $this->page('topm/member/point/indexoff.html',$pagedata);
    }
    ...
    public function __getPoints($filter)
    {
        ...
        $data = app::get('topm')->rpcCall('user.pointGet.off',$params);
        ...
        $pagedata['pagers'] = array(
            'link'=>url::action('topm_ctl_member_pointoff@point',$filter),
            'current'=>$current,
            'total'=>$total,
        );
        return $pagedata;
